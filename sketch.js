...
function menu() {
  ...
  text("Choose 1 item from the menu bellow! The robot must click the button first, and then the chef can pick!", windowWidth/2 - 200, 100)
  item1.show()
  item2.show()
  item3.show()
  item4.show()
